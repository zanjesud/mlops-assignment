...
@click.option("--experiment_name", default="iris-classifier-cicd", help="MLflow experiment name")
@click.option("--model_name", default="iris_classifier", help="Model name for registration")
def train_model(data_path, experiment_name, model_name):
    ...
    with mlflow.start_run() as run:
        ...
        # Data validation
        required_columns = ['sepal length (cm)', 'sepal width (cm)', 'petal length (cm)', 'petal width (cm)', 'target']
